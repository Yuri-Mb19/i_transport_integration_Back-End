...
<body>
    ...
    <div class="info-section">
        <div class="info-content">
            <h2>For over a dozen years we have been providing the best transport services. We offer bus, passenger
                transport, and limousine rental.</h2>
            <p>We address our offer to all who want to travel in comfortable conditions. We have over 120 top-class
                vehicles, so our customers can be assured of comfort and safety.</p>
            <ul class="info-checklist">
                <li><i class="fas fa-check-circle"></i> Professionally Trained Chauffeurs</li>
                <li><i class="fas fa-check-circle"></i> 24/7 Full-Service Transportation</li>
                <li><i class="fas fa-check-circle"></i> Global network of Transportation Partners</li>
            </ul>
        </div>
        <div class="info-image">
            <img src="images/image_01-5.jpg" alt="Transportation service">
        </div>
    </div>
