...
<head>
    ...
    <link rel="stylesheet" href="what-our-clients-say.css">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" rel="stylesheet">
...
<body>
    ...
    <div class="testimonials-section">
        ...
        <div class="testimonials-container">
            ...
            <div class="testimonial">
                ...
                <p>
                    I couldn’t be happier with the transport you did. It was great and your car was amazing. 
            ...
            <div class="testimonial">
                <i class="fas fa-comment-alt"></i>
                <p>
                    Great experience with this company. I have used many others in Oakland but this was by far the best.
                    You guys made our trip so easy. Great customer service, wonderful drivers, and the most affordable 
                    transportation company I have used. Thank you soo much!
                </p>
                <h4>MARK</h4>
            </div>
            <!-- Testemunho 3 -->
            <div class="testimonial">
                <i class="fas fa-comment-alt"></i>
                <p>
                    I hired AutoRide to pick me up at the airport with their Sedan. I had just got back from a long trip in Germany 
                    and was very tired. The driver was on time and extremely courteous and I had no problems at all. Great service!
                </p>
                <h4>KEVIN FOSTER</h4>
            </div>
            <!-- Testemunho 4 -->
            <div class="testimonial">
                <i class="fas fa-comment-alt"></i>
                <p>
                    Our drivers for this trip were excellent. They were on time, they were kind, they were professional. They each went above 
                    and beyond to give our campers an excellent experience. In my opinion, they were two of the best drivers we’ve had in the last few summers.
                </p>
                <h4>ANN 36</h4>
            </div>
            <!-- Testemunho 5 -->
            <div class="testimonial">
                <i class="fas fa-comment-alt"></i>
                <p>
                    Our driver was the best we could ask for. It’s the driver that tames the bus, not the other way around. He deserves recognition 
                    for his commitment to work.
                </p>
                <h4>HENRY SMITH</h4>
            </div>
            <!-- Testemunho 6 -->
            <div class="testimonial">
                ...
                <p>
                    ...
                    His skills helped avoid traffic jams. I will recommend AutoRide to all my friends!
                </p>
                <h4>MITCH MICHAEL</h4>
            </div>
        </div>
    ...
    <script src="what-our-clients-say.js"></script>
</body>
